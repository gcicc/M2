...
format: 
  pdf:
    header-includes: 
      ...
      - \usepackage{float}  # Added for precise float control
    include-in-header: 
      text: |
        \usepackage{scrlayer-scrpage}
        \cohead[{\includegraphics[height=4cm]{images/Logo.png}}]{Agreement of MARCS Score Relative to Path}
...
functions_path <- path(repo_clone, "CE-VAST-Agreement", "functions")
